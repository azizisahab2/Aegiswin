...
public class Class1
{
    ...
    public Class1()
    {
        con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\admin\source\repos\Aegiswin\App_Data\Database1.mdf;Integrated Security=True");
    }
